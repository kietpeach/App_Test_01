...
class grpcMasterServiceClient extends $grpc.Client {
  ...
  static final _$updateDeptFromStaffToWage = $grpc.ClientMethod<$1.UpdateDeptFromStaffToWage_Request, $0.Empty_Response>(
      '/grpcMasterService.grpcMasterService/UpdateDeptFromStaffToWage',
      ($1.UpdateDeptFromStaffToWage_Request value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.Empty_Response.fromBuffer(value));
  static final _$saveComboProduct = $grpc.ClientMethod<$1.SaveComboProduct_Request, $0.String_Response>(
      '/grpcMasterService.grpcMasterService/SaveComboProduct',
      ($1.SaveComboProduct_Request value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.String_Response.fromBuffer(value));
  static final _$getComboProduct = $grpc.ClientMethod<$0.String_Request, $1.GetComboProduct_Response>(
      '/grpcMasterService.grpcMasterService/GetComboProduct',
      ($0.String_Request value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.GetComboProduct_Response.fromBuffer(value));
  static final _$getSettingMasterRecord = $grpc.ClientMethod<$0.String_Request, $1.GetSettingMasterRecord_Response>(
      '/grpcMasterService.grpcMasterService/GetSettingMasterRecord',
      ($0.String_Request value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.GetSettingMasterRecord_Response.fromBuffer(value));
  ...
  static final _$getSlistVendor = $grpc.ClientMethod<$0.Empty_Request, $1.GetVendor_Response>(
      ...
      ($0.Empty_Request value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.GetVendor_Response.fromBuffer(value));
  static final _$updateVendorContact = $grpc.ClientMethod<$1.UpdateVendorContact_Request, $0.Empty_Response>(
      '/grpcMasterService.grpcMasterService/UpdateVendorContact',
      ($1.UpdateVendorContact_Request value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.Empty_Response.fromBuffer(value));
  static final _$checkDuplicatedVendorName = $grpc.ClientMethod<$1.CheckDuplicatedVendorName_Request, $0.Bool_Response>(
      '/grpcMasterService.grpcMasterService/CheckDuplicatedVendorName',
      ($1.CheckDuplicatedVendorName_Request value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.Bool_Response.fromBuffer(value));
  static final _$checkDuplicatedVendorFullName = $grpc.ClientMethod<$1.CheckDuplicatedVendorFullName_Request, $0.Bool_Response>(
      '/grpcMasterService.grpcMasterService/CheckDuplicatedVendorFullName',
      ($1.CheckDuplicatedVendorFullName_Request value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.Bool_Response.fromBuffer(value));
  static final _$checkDuplicatedVendorTaxCode = $grpc.ClientMethod<$1.CheckDuplicatedVendorTaxCode_Request, $0.Bool_Response>(
      '/grpcMasterService.grpcMasterService/CheckDuplicatedVendorTaxCode',
      ($1.CheckDuplicatedVendorTaxCode_Request value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.Bool_Response.fromBuffer(value));
  ...
  static final _$updateProduct = $grpc.ClientMethod<$1.UpdateProduct_Request, $0.Empty_Response>(
      ...
      ($core.List<$core.int> value) => $0.Empty_Response.fromBuffer(value));
  static final _$checkDuplicatedName = $grpc.ClientMethod<$1.CheckDuplicatedName_Request, $0.Bool_Response>(
      '/grpcMasterService.grpcMasterService/CheckDuplicatedName',
      ($1.CheckDuplicatedName_Request value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.Bool_Response.fromBuffer(value));
  static final _$checkDuplicatedHSCode = $grpc.ClientMethod<$1.CheckDuplicatedHSCode_Request, $0.Bool_Response>(
      '/grpcMasterService.grpcMasterService/CheckDuplicatedHSCode',
      ($1.CheckDuplicatedHSCode_Request value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.Bool_Response.fromBuffer(value));
  static final _$checkDuplicatedBarCode = $grpc.ClientMethod<$1.CheckDuplicatedBarCode_Request, $0.Bool_Response>(
      '/grpcMasterService.grpcMasterService/CheckDuplicatedBarCode',
      ($1.CheckDuplicatedBarCode_Request value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.Bool_Response.fromBuffer(value));
  ...
  static final _$getCustomer = $grpc.ClientMethod<$1.GetCustomer_Request, $1.GetCustomer_Response>(
      ...
      ($core.List<$core.int> value) => $1.GetCustomer_Response.fromBuffer(value));
  static final _$checkDuplicatedCustomerName = $grpc.ClientMethod<$1.CheckDuplicatedCustomerName_Request, $0.Bool_Response>(
      '/grpcMasterService.grpcMasterService/CheckDuplicatedCustomerName',
      ($1.CheckDuplicatedCustomerName_Request value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.Bool_Response.fromBuffer(value));
  static final _$checkDuplicatedCustomerFullName = $grpc.ClientMethod<$1.CheckDuplicatedCustomerFullName_Request, $0.Bool_Response>(
      '/grpcMasterService.grpcMasterService/CheckDuplicatedCustomerFullName',
      ($1.CheckDuplicatedCustomerFullName_Request value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.Bool_Response.fromBuffer(value));
  static final _$checkDuplicatedCustomerTaxCode = $grpc.ClientMethod<$1.CheckDuplicatedCustomerTaxCode_Request, $0.Bool_Response>(
      '/grpcMasterService.grpcMasterService/CheckDuplicatedCustomerTaxCode',
      ($1.CheckDuplicatedCustomerTaxCode_Request value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.Bool_Response.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.Empty_Response> updateDeptFromStaffToWage($1.UpdateDeptFromStaffToWage_Request request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$updateDeptFromStaffToWage, request, options: options);
  }

  $grpc.ResponseFuture<$0.String_Response> saveComboProduct($1.SaveComboProduct_Request request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$saveComboProduct, request, options: options);
  }

  $grpc.ResponseFuture<$1.GetComboProduct_Response> getComboProduct($0.String_Request request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getComboProduct, request, options: options);
  }

  $grpc.ResponseFuture<$1.GetSettingMasterRecord_Response> getSettingMasterRecord($0.String_Request request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getSettingMasterRecord, request, options: options);
  }
  ...
  $grpc.ResponseFuture<$0.Empty_Response> updateVendorContact($1.UpdateVendorContact_Request request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$updateVendorContact, request, options: options);
  }

  $grpc.ResponseFuture<$0.Bool_Response> checkDuplicatedVendorName($1.CheckDuplicatedVendorName_Request request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$checkDuplicatedVendorName, request, options: options);
  }

  $grpc.ResponseFuture<$0.Bool_Response> checkDuplicatedVendorFullName($1.CheckDuplicatedVendorFullName_Request request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$checkDuplicatedVendorFullName, request, options: options);
  }

  $grpc.ResponseFuture<$0.Bool_Response> checkDuplicatedVendorTaxCode($1.CheckDuplicatedVendorTaxCode_Request request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$checkDuplicatedVendorTaxCode, request, options: options);
  }
  ...
  $grpc.ResponseFuture<$0.Bool_Response> checkDuplicatedName($1.CheckDuplicatedName_Request request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$checkDuplicatedName, request, options: options);
  }

  $grpc.ResponseFuture<$0.Bool_Response> checkDuplicatedHSCode($1.CheckDuplicatedHSCode_Request request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$checkDuplicatedHSCode, request, options: options);
  }

  $grpc.ResponseFuture<$0.Bool_Response> checkDuplicatedBarCode($1.CheckDuplicatedBarCode_Request request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$checkDuplicatedBarCode, request, options: options);
  }
  ...
  $grpc.ResponseFuture<$0.Bool_Response> checkDuplicatedCustomerName($1.CheckDuplicatedCustomerName_Request request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$checkDuplicatedCustomerName, request, options: options);
  }

  $grpc.ResponseFuture<$0.Bool_Response> checkDuplicatedCustomerFullName($1.CheckDuplicatedCustomerFullName_Request request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$checkDuplicatedCustomerFullName, request, options: options);
  }

  $grpc.ResponseFuture<$0.Bool_Response> checkDuplicatedCustomerTaxCode($1.CheckDuplicatedCustomerTaxCode_Request request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$checkDuplicatedCustomerTaxCode, request, options: options);
  }
...
abstract class grpcMasterServiceBase extends $grpc.Service {
  ...
  grpcMasterServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$1.UpdateDeptFromStaffToWage_Request, $0.Empty_Response>(
        'UpdateDeptFromStaffToWage',
        updateDeptFromStaffToWage_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $1.UpdateDeptFromStaffToWage_Request.fromBuffer(value),
        ($0.Empty_Response value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.SaveComboProduct_Request, $0.String_Response>(
        'SaveComboProduct',
        saveComboProduct_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $1.SaveComboProduct_Request.fromBuffer(value),
        ($0.String_Response value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.String_Request, $1.GetComboProduct_Response>(
        'GetComboProduct',
        getComboProduct_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.String_Request.fromBuffer(value),
        ($1.GetComboProduct_Response value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.String_Request, $1.GetSettingMasterRecord_Response>(
        'GetSettingMasterRecord',
        getSettingMasterRecord_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.String_Request.fromBuffer(value),
        ($1.GetSettingMasterRecord_Response value) => value.writeToBuffer()));
    ...
    $addMethod($grpc.ServiceMethod<$0.Empty_Request, $1.GetVendor_Response>(
        ...
        ($core.List<$core.int> value) => $0.Empty_Request.fromBuffer(value),
        ($1.GetVendor_Response value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.UpdateVendorContact_Request, $0.Empty_Response>(
        'UpdateVendorContact',
        updateVendorContact_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $1.UpdateVendorContact_Request.fromBuffer(value),
        ($0.Empty_Response value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.CheckDuplicatedVendorName_Request, $0.Bool_Response>(
        'CheckDuplicatedVendorName',
        checkDuplicatedVendorName_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $1.CheckDuplicatedVendorName_Request.fromBuffer(value),
        ($0.Bool_Response value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.CheckDuplicatedVendorFullName_Request, $0.Bool_Response>(
        'CheckDuplicatedVendorFullName',
        checkDuplicatedVendorFullName_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $1.CheckDuplicatedVendorFullName_Request.fromBuffer(value),
        ($0.Bool_Response value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.CheckDuplicatedVendorTaxCode_Request, $0.Bool_Response>(
        'CheckDuplicatedVendorTaxCode',
        checkDuplicatedVendorTaxCode_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $1.CheckDuplicatedVendorTaxCode_Request.fromBuffer(value),
        ($0.Bool_Response value) => value.writeToBuffer()));
    ...
    $addMethod($grpc.ServiceMethod<$1.UpdateProduct_Request, $0.Empty_Response>(
        ...
        ($0.Empty_Response value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.CheckDuplicatedName_Request, $0.Bool_Response>(
        'CheckDuplicatedName',
        checkDuplicatedName_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $1.CheckDuplicatedName_Request.fromBuffer(value),
        ($0.Bool_Response value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.CheckDuplicatedHSCode_Request, $0.Bool_Response>(
        'CheckDuplicatedHSCode',
        checkDuplicatedHSCode_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $1.CheckDuplicatedHSCode_Request.fromBuffer(value),
        ($0.Bool_Response value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.CheckDuplicatedBarCode_Request, $0.Bool_Response>(
        'CheckDuplicatedBarCode',
        checkDuplicatedBarCode_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $1.CheckDuplicatedBarCode_Request.fromBuffer(value),
        ($0.Bool_Response value) => value.writeToBuffer()));
    ...
    $addMethod($grpc.ServiceMethod<$1.GetCustomer_Request, $1.GetCustomer_Response>(
        ...
        ($1.GetCustomer_Response value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.CheckDuplicatedCustomerName_Request, $0.Bool_Response>(
        'CheckDuplicatedCustomerName',
        checkDuplicatedCustomerName_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $1.CheckDuplicatedCustomerName_Request.fromBuffer(value),
        ($0.Bool_Response value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.CheckDuplicatedCustomerFullName_Request, $0.Bool_Response>(
        'CheckDuplicatedCustomerFullName',
        checkDuplicatedCustomerFullName_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $1.CheckDuplicatedCustomerFullName_Request.fromBuffer(value),
        ($0.Bool_Response value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.CheckDuplicatedCustomerTaxCode_Request, $0.Bool_Response>(
        'CheckDuplicatedCustomerTaxCode',
        checkDuplicatedCustomerTaxCode_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $1.CheckDuplicatedCustomerTaxCode_Request.fromBuffer(value),
        ($0.Bool_Response value) => value.writeToBuffer()));
  ...
  $async.Future<$0.Empty_Response> updateDeptFromStaffToWage_Pre($grpc.ServiceCall call, $async.Future<$1.UpdateDeptFromStaffToWage_Request> request) async {
    return updateDeptFromStaffToWage(call, await request);
  }

  $async.Future<$0.String_Response> saveComboProduct_Pre($grpc.ServiceCall call, $async.Future<$1.SaveComboProduct_Request> request) async {
    return saveComboProduct(call, await request);
  }

  $async.Future<$1.GetComboProduct_Response> getComboProduct_Pre($grpc.ServiceCall call, $async.Future<$0.String_Request> request) async {
    return getComboProduct(call, await request);
  }

  $async.Future<$1.GetSettingMasterRecord_Response> getSettingMasterRecord_Pre($grpc.ServiceCall call, $async.Future<$0.String_Request> request) async {
    return getSettingMasterRecord(call, await request);
  }
  ...
  $async.Future<$0.Empty_Response> updateVendorContact_Pre($grpc.ServiceCall call, $async.Future<$1.UpdateVendorContact_Request> request) async {
    return updateVendorContact(call, await request);
  }

  $async.Future<$0.Bool_Response> checkDuplicatedVendorName_Pre($grpc.ServiceCall call, $async.Future<$1.CheckDuplicatedVendorName_Request> request) async {
    return checkDuplicatedVendorName(call, await request);
  }

  $async.Future<$0.Bool_Response> checkDuplicatedVendorFullName_Pre($grpc.ServiceCall call, $async.Future<$1.CheckDuplicatedVendorFullName_Request> request) async {
    return checkDuplicatedVendorFullName(call, await request);
  }

  $async.Future<$0.Bool_Response> checkDuplicatedVendorTaxCode_Pre($grpc.ServiceCall call, $async.Future<$1.CheckDuplicatedVendorTaxCode_Request> request) async {
    return checkDuplicatedVendorTaxCode(call, await request);
  }
  ...
  $async.Future<$0.Bool_Response> checkDuplicatedName_Pre($grpc.ServiceCall call, $async.Future<$1.CheckDuplicatedName_Request> request) async {
    return checkDuplicatedName(call, await request);
  }

  $async.Future<$0.Bool_Response> checkDuplicatedHSCode_Pre($grpc.ServiceCall call, $async.Future<$1.CheckDuplicatedHSCode_Request> request) async {
    return checkDuplicatedHSCode(call, await request);
  }

  $async.Future<$0.Bool_Response> checkDuplicatedBarCode_Pre($grpc.ServiceCall call, $async.Future<$1.CheckDuplicatedBarCode_Request> request) async {
    return checkDuplicatedBarCode(call, await request);
  }
  ...
  $async.Future<$0.Bool_Response> checkDuplicatedCustomerName_Pre($grpc.ServiceCall call, $async.Future<$1.CheckDuplicatedCustomerName_Request> request) async {
    return checkDuplicatedCustomerName(call, await request);
  }

  $async.Future<$0.Bool_Response> checkDuplicatedCustomerFullName_Pre($grpc.ServiceCall call, $async.Future<$1.CheckDuplicatedCustomerFullName_Request> request) async {
    return checkDuplicatedCustomerFullName(call, await request);
  }

  $async.Future<$0.Bool_Response> checkDuplicatedCustomerTaxCode_Pre($grpc.ServiceCall call, $async.Future<$1.CheckDuplicatedCustomerTaxCode_Request> request) async {
    return checkDuplicatedCustomerTaxCode(call, await request);
  }
  ...
  $async.Future<$0.Empty_Response> updateDeptFromStaffToWage($grpc.ServiceCall call, $1.UpdateDeptFromStaffToWage_Request request);
  $async.Future<$0.String_Response> saveComboProduct($grpc.ServiceCall call, $1.SaveComboProduct_Request request);
  $async.Future<$1.GetComboProduct_Response> getComboProduct($grpc.ServiceCall call, $0.String_Request request);
  $async.Future<$1.GetSettingMasterRecord_Response> getSettingMasterRecord($grpc.ServiceCall call, $0.String_Request request);
  ...
  $async.Future<$0.Empty_Response> updateVendorContact($grpc.ServiceCall call, $1.UpdateVendorContact_Request request);
  $async.Future<$0.Bool_Response> checkDuplicatedVendorName($grpc.ServiceCall call, $1.CheckDuplicatedVendorName_Request request);
  $async.Future<$0.Bool_Response> checkDuplicatedVendorFullName($grpc.ServiceCall call, $1.CheckDuplicatedVendorFullName_Request request);
  $async.Future<$0.Bool_Response> checkDuplicatedVendorTaxCode($grpc.ServiceCall call, $1.CheckDuplicatedVendorTaxCode_Request request);
  ...
  $async.Future<$0.Bool_Response> checkDuplicatedName($grpc.ServiceCall call, $1.CheckDuplicatedName_Request request);
  $async.Future<$0.Bool_Response> checkDuplicatedHSCode($grpc.ServiceCall call, $1.CheckDuplicatedHSCode_Request request);
  $async.Future<$0.Bool_Response> checkDuplicatedBarCode($grpc.ServiceCall call, $1.CheckDuplicatedBarCode_Request request);
  ...
  $async.Future<$0.Bool_Response> checkDuplicatedCustomerName($grpc.ServiceCall call, $1.CheckDuplicatedCustomerName_Request request);
  $async.Future<$0.Bool_Response> checkDuplicatedCustomerFullName($grpc.ServiceCall call, $1.CheckDuplicatedCustomerFullName_Request request);
  $async.Future<$0.Bool_Response> checkDuplicatedCustomerTaxCode($grpc.ServiceCall call, $1.CheckDuplicatedCustomerTaxCode_Request request);
